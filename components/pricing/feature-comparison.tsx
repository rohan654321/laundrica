      ...
      <table className="w-full min-w-[600px]">
        <thead>
          <tr className="border-b border-gray-200">
            ...
            <th className="text-center py-4 px-6 font-semibold text-gray-800">
            ...
            <th className="text-center py-4 px-6 font-semibold text-gray-800">
              <div className="flex flex-col items-center gap-2">
                <motion.div
                  className="w-8 h-8 bg-[#1f4f2b] rounded-lg flex items-center justify-center ring-2 ring-[#1f4f2b]/30"
          ...
          {categories.map((category, categoryIndex) => {
            ...
            return (
              <motion.tbody key={category} variants={tableVariants}>
                ...
                <tr>
                  <td colSpan={4} className="py-3 px-6 bg-[#e8f3e6] rounded-lg mb-2">
                    <p className="text-sm font-bold text-[#1f4f2b] uppercase tracking-wide">{category}</p>
                  </td>
                </tr>
                {categoryFeatures.map((feature, index) => (
                  ...
                  >
                    <td className="py-4 px-6 text-gray-700 text-sm">{feature.name}</td>

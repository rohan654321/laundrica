              ...
              {({ isActive }) => (
                <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
                  ...
                  <div className="absolute inset-0">
                    ...
                    {/* Animated blobs */}
                    <motion.div
                      className="absolute top-10 md:top-20 -left-40 w-80 h-80 bg-primary/10 rounded-full blur-3xl"
                      animate={{ y: [0, 50, 0] }}
                  ...
                  <div className="relative z-10 container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center max-w-6xl mx-auto">
                      ...
                      >
                        {/* Badge */}
                        <motion.div
                          className="inline-flex items-center gap-2 px-4 py-2 mb-6 glassmorphism rounded-full"
                          ...
                          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                            <Link href="/about">
                              <Button 
                                size="lg" 
                                variant="outline" 
                                className="rounded-full px-8 font-semibold border-2 hover:bg-white/5"
                              >
                                Learn More
                              </Button>
                            </Link>
